...
recipes.addShaped(<rftools:machine_frame>, [[<ore:ingotMorganine>, <ore:ingotHardCarbon>, <ore:ingotMorganine>],[<ore:nuggetGold>, null, <ore:nuggetGold>], [<ore:ingotMorganine>, <ore:ingotHardCarbon>, <ore:ingotMorganine>]]);
